                        ...
                        <div class="card">
	                        ...
	                        <div class="card-body"> 
	                              <div> Language: <h6 class="card-subtitle">${movie.languages}</h6> 
	                               ...
	                               Kind:<h6>${movie.king}</h6>
	                               Description:<h6>${movie.description}</h6>
	                        <div>
	                               <h5>Programs:</h5>
		                         ...
		                         <div> Author:<h6>${movie.author}</h6>
				                    Adresse:<h6>${movie.adr.number} ${movie.adr.way} ${movie.adr.postalCode} ${movie.adr.town} ${movie.adr.country}</h6>
				                    Min age:<h6>${movie.minAge}</h6>
				                    Actors:<h6>${movie.actors[0].fisrtName} </h6>
					                   <form class="form-horizontal m-t-20" id="loginform">
					                        <div class="dt-buttons">
					                           <a href="http://localhost:8080/MoviesClient" class="button">Retour</a>
